...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    try {
      ...
      if (!query) {
        const player = lavalinkService.lavashark.players.get(interaction.guildId!) as Player | undefined;
      ...
      let player = lavalinkService.lavashark.players.get(interaction.guildId!) as Player | undefined;
      if (!player) {
